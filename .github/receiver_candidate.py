...
"""
replace_once(cpp, old_builder, new_builder)
...
replace_once("receive/main.js", 'const RECEIVER_RUNTIME_BUILD = "v0.5.325";', 'const RECEIVER_RUNTIME_BUILD = "v0.5.326";')
replace_once("send/main.js", 'const SEND_RUNTIME_BUILD = "v0.5.325";', 'const SEND_RUNTIME_BUILD = "v0.5.326";')
replace_once("main.js", 'const APP_BUILD = "v0.5.325";', 'const APP_BUILD = "v0.5.326";')
replace_once("index.html", '<span class="app-version">v0.5.325</span>', '<span class="app-version">v0.5.326</span>')
replace_once("index.html", './main.js?build=v0.5.325', './main.js?build=v0.5.326')
replace_once("sw.js", 'const CACHE = "airgapper-static-js-v273";', 'const CACHE = "airgapper-static-js-v274";')

print("staged v0.5.326: sequential sparse maps and lazy erasure-score allocation")
