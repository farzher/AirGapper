...
replace_once(worker, "const GUIDED_METRICS_BYTES = 232;", "const GUIDED_METRICS_BYTES = 208;")
replace_once(
    worker,
...
replace_once(main, 'const RECEIVER_RUNTIME_BUILD = "v0.5.332";', 'const RECEIVER_RUNTIME_BUILD = "v0.5.333";')
replace_once("send/main.js", 'const SEND_RUNTIME_BUILD = "v0.5.332";', 'const SEND_RUNTIME_BUILD = "v0.5.333";')
replace_once("main.js", 'const APP_BUILD = "v0.5.332";', 'const APP_BUILD = "v0.5.333";')
replace_once("index.html", '<span class="app-version">v0.5.332</span>', '<span class="app-version">v0.5.333</span>')
replace_once("index.html", './main.js?build=v0.5.332', './main.js?build=v0.5.333')
replace_once("sw.js", 'const CACHE = "airgapper-static-js-v280";', 'const CACHE = "airgapper-static-js-v281";')

print("staged v0.5.333: remove temporary Stable-RS lane instrumentation")
