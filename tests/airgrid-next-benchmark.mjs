...
try{
  ...
  if(report.labSmoke?.workerBuild!=='v35f'||!report.labSmoke?.versionText.includes('v35f')||!report.labSmoke.versionText.includes('hardware lab')||!report.labSmoke?.autoSender||!report.labSmoke?.autoReceiver||!report.labSmoke?.exportJson||!report.labSmoke?.exportCsv||!report.labSmoke?.staleResultsCleared||!report.labSmoke.receiverVisible||!report.labSmoke.senderHidden)failures.push('automated hardware lab receiver UI did not initialize');
