...
class FocusController {
  constructor(apply, changed, strategy = "auto", manualDistance, calibrationMode = "auto", currentScanId = () => 0) {
    ...
    this.calibrationMode = undefined;
    this.manualDistance = undefined;
    this.generation = 0;
    this.attachedAt = 0;
    ...
    this.lastReason = "camera opened";
    this.baselineFocus = undefined;
    ...
    this.lockedAt = 0;
    this.fullResetCount = 0;
    this.focusRefinementCount = 0;
    this.exposureRefinementCount = 0;
