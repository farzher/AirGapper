...
6. After the first low-resolution local header passes, lazily draw the source frame once and read each accepted full-resolution tile ROI from that cache.
